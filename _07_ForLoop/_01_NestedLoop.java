...
public class _01_NestedLoop {
    ...
    public static void main(String[] args) {
         ...
         //Eger bir dongunun gövdesinde diger bir dongu bulunuyorsa,
         //Bu tur donguler ic-ice donguler olarak bilinir
         //icteki dongu dýstaki dongunun her adýmýnda yenidencalýstýrýlacaktýr
         //Ic ice dongulerde en icteki dongu en önce tamamlanýr.
